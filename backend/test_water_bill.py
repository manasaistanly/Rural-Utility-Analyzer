"""
Test OCR on the water bill image
"""
import sys
import os
...
# Save to file
with open("water_bill_test_results.txt", "w", encoding="utf-8") as f:
    f.write("="*80 + "\n")
    f.write("WATER BILL OCR TEST\n")
    f.write("="*80 + "\n\n")
    f.write("Raw Text:\n")
    f.write(text + "\n\n")
    f.write("="*80 + "\n")
...
print("\n" + "="*80)
print("Results saved to water_bill_test_results.txt")
print("="*80)
